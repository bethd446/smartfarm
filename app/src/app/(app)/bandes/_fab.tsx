...
/**
 * Smart Farm — FAB Bandes (Floating Action Button)
 * ============================================================================
 * Bouton flottant mobile pour déclencher la création d'une nouvelle bande.
 * Action principale métier : "Nouvelle bande"
 * ============================================================================
 */
export function BandesFab() {
  ...
  return (
    <>
      ...
      >
        <Layers className="h-6 w-6" strokeWidth={2.5} aria-hidden />
      </button>
      <DialogNouvelleBande open={open} onOpenChange={setOpen} />
    </>
  )
}
