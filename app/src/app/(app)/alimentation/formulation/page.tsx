      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold flex items-center gap-2">
            <Beaker className="h-7 w-7 text-[var(--sf-accent-warm,#A16207)]" />
            Formulations
          </h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">
            ...
            <span className="ml-2 text-xs font-normal text-[var(--sf-muted,#5C5346)]">
        ...
        <CardContent>
          {formulations.length === 0 ? (
            <div className="text-sm text-[var(--sf-muted,#5C5346)] py-8 text-center">
