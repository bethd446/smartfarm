...
/**
 * Smart Farm — FAB Alimentation (Floating Action Button)
 * ============================================================================
 * Bouton flottant mobile qui redirige vers les consommations.
 * Le hub alimentation n'a pas d'action directe de création, mais le module
 * consommations est la destination principale pour saisir une nouvelle conso.
 * ============================================================================
 */
export function AlimentationFab() {
  return (
    <Link
