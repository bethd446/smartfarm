...
/**
 * Smart Farm — FAB Sanitaire (Floating Action Button)
 * ============================================================================
 * Bouton flottant mobile qui redirige vers le calendrier sanitaire.
 * Le hub sanitaire n'a pas d'action directe de création, mais le module
 * calendrier est la destination principale pour enregistrer des actes.
 * ============================================================================
 */
export function SanitaireFab() {
  return (
    <Link
      href="/sanitaire/calendrier"
      aria-label="Calendrier sanitaire"
      className={[
